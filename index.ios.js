  ...
  render() {
    return (
      <Navigator
        ...
        navigationBar={
          <Navigator.NavigationBar style={{ backgroundColor: '#4085FF', alignItems: 'center'}}
...
var NavigationBarRouteMapper = {
  ...
  Title(route, navigator, index, navState) {
    if (route.id === 'UserPref') {
      return (
        <Text style={{ color: 'white', margin: 10, fontSize: 20, alignSelf: 'center',textAlign:'center',marginRight:30,marginTop:12}}>
              Route Results
        </Text>
      );
    }
